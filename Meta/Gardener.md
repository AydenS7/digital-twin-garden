...
- **`Daily/` and `Frontier/` belong to the Sower** (`Meta/Sower.md`). Leave recent daily notes alone; you may archive daily notes older than 30 days. Don't reorganize or compact `Frontier/`.
...
- Sower agent merged into Daily Five, then reverted: the Sower name/framework stays, with the daily 5-item output folded into it as one agent.
